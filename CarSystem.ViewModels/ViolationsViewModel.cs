...
namespace CarSystem.ViewModels
{
	public class ViolationsViewModel : INotifyPropertyChanged
	{
		...
		public int PersonFineId
		{
			...
			set { this.personFineId = value; NotifyPropertyChanged(); }
		}
		...
		public string FinePrice
		{
			...
			set { this.finePrice = value; NotifyPropertyChanged(); }
		}
		...
		public string CardId
		{
			...
			set { this.cardId = value; NotifyPropertyChanged(); }
		}
		...
		public string CarBrand
		{
			...
			set { this.carBrand = value; NotifyPropertyChanged(); }
		}
		...
		public string CarModel
		{
			...
			set { this.carModel = value; NotifyPropertyChanged(); }
		}
		...
		public string CarNumber
		{
			...
			set { this.carNumber = value; NotifyPropertyChanged(); }
		}
